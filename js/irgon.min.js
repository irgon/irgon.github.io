...
this.postContainer.find(".translate-"+b).html(a.description[b]);e.empty();for(d in a.technologies)a.technologies.hasOwnProperty(d)&&(b=a.technologies[d],e.append(c('<li><abbr title="'+this.TECH[d][1]+'">'+this.TECH[d][0]+(b?" "+b:"")+"</abbr></li>")));c("li:last",e).addClass("last");e.append(c('<li class="date"><span class="'+this.MONTHS[g[1]].toLowerCase()+'">'+this.MONTHS[g[1]]+"</span> "+g[0]+"</li>"));a.preview&&e.append(c('<li class="preview"><a href="/'+a.id+'/" target="_blank">See preview</a></li>'));
a.online&&e.append(c('<li class="online"><a href="'+a.url+'" target="_blank" rel="nofollow">See online</a></li>'));this.arrowsContainer.fadeIn(1E3,function(){c(this).parent().removeClass("list")});f.translate(f.currentLanguage);this.imgPreview.attr("src","/images/posts/"+a.id+".jpg");0<this.imgPreview.height()&&c("body").removeClass("loading");c("#content").addClass("view-item").removeClass("view-list");this.postContainer.show();this.listContainer.hide()},sliderJsFallback:function(){var a=this;this.sliderContainer.find("li").css("opacity",
1).hide().filter(":first").show();setInterval(function(){var b=a.sliderContainer.find("li:visible");b.fadeOut(1E3);b.next().is("li")?b.next().fadeIn():b.parent().find(":first").fadeIn(1E3)},5E3)}};c(document).ready(function(){c("body").removeClass("no-js");f.init();h.init();"undefined"===typeof document.body.style.MozAnimation&&("undefined"===typeof document.body.style.WebkitAnimation&&"undefined"===typeof document.body.style.OAnimation&&"undefined"===typeof document.body.style.MsAnimation&&"undefined"===
typeof document.body.style.Animation)&&(c("body").addClass("no-anim"),h.sliderJsFallback());c("#top h1 a").fitText(0.433)});c(window).on("resize",function(){var a=c("#slider"),b=a.find("img"),d=a.find("li");a.height(0.618033988*a.width());b.width(a.width());d.width(b.width()).height(b.height()).css("marginTop","-"+b.height()/2+"px").css("marginLeft","-"+b.width()/2+"px")}).resize()})(jQuery);