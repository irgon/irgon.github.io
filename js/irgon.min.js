...
a.showList()});c(".prev a",this.arrowsContainer).click(function(b){b.preventDefault();a.showPreviousPost()});c(".next a",this.arrowsContainer).click(function(b){b.preventDefault();a.showNextPost()});c(document).bind(c.browser.opera?"keypress":"keydown",function(b){if(117===b.keyCode||117===b.charCode||85===b.keyCode||85===b.charCode)b.preventDefault(),window.location.href="https://github.com/irgon/irgon.github.com/";if(!b.charCode)switch(b.keyCode){case 37:b.preventDefault();a.showPreviousPost();break;case 40:b.preventDefault();
